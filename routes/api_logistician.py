...
from services.supplier_scoring import score_suppliers_for_material
from services.ml_dataset import build_supplier_ml_dataset
from services.ml_training import train_supplier_risk_model
...
def recommend_suppliers():
    ...
    result = score_suppliers_for_material(
        material_id=material_id,
        scenario=scenario
    )
...
@api_logistician_bp.route('/api/logistician/ml-dataset-preview')
@role_required('logistician')
...
@api_logistician_bp.route('/api/logistician/train-supplier-risk-model', methods=['POST'])
@role_required('logistician')
def train_supplier_risk_model_api():
